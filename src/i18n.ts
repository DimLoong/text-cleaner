...
const messages = {
  zh: {
    ...
    emptyTitle: '清理后的文本会出现在这里', emptyHint: '输入文本后，所有调整都会实时预览', hoverHint: '悬浮选择片段 · 拖动可多选 · 单击复制', copied: '已复制', copiedAll: '已复制', copyFailed: '复制失败，请手动选择复制', pasteFailed: '无法读取剪贴板，请直接粘贴',
  ...
  en: {
    ...
    emptyTitle: 'Your cleaned text will appear here', emptyHint: 'Every adjustment previews instantly as you type', hoverHint: 'Hover a phrase · Drag to select · Click to copy', copied: 'Copied', copiedAll: 'Copied', copyFailed: 'Copy failed — select and copy manually', pasteFailed: 'Clipboard access failed — paste directly instead',
